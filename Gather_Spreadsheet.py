...
golf = pd.concat([universal.loc["Height_(ft-in)":"Team_Wins", "Evan"], df.loc["1st_Place":"3rd_Place", "Evan"], df.loc["Drive_Distance_(ft)":"Average Score", "Evan"]])
baseball = pd.concat([universal.loc["Height_(ft-in)":"Team_Wins", "Kyle"], df.loc["Plate_Appearances":"Changeup_Velocity_(mph)", "Kyle"]])
